var schemata = require('schemata')
  , socialSchema = require('./social-schema')
  // , bodySchema = require('./body-schema')
  , tagSchema = require('./tag-schema')
  , validity = require('validity')
  , dateBeforeExpiryValidator =
    require('validity-date-before-property')('expiryDate')
  , dateBeforeArchiveValidator =
    require('validity-date-before-property')('archiveDate', 'archive date')
  , imageIntegrityValidator =
    require('../../lib/validators/crop-integrity-validator')
...
module.exports = function (imageConfig, save) {
  ...
  var cropsRequired = require('../../lib/validators/crop-validator')(imageConfig)
    , fullUrlUniqueValidator = customValidityMessage(createUniqueValidator(save.findOne, { keys: ['section'] }),
  ...
  return schemata(
    ...
    , images:
      ...
      , validators:
        { draft: []
        , published: [imageIntegrityValidator]
        , archived: [imageIntegrityValidator]
        }
      }
    , downloads:
      { type: Object
    ...
    , social:
      { type: schemata.Array(socialSchema)
      , validators:
        { draft: []
        , published: []
        , archived: []
